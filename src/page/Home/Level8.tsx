  ...
  return (
    <div>
      <Wrapper>
        {/* container with data */}
        <Data
          titleText="The squirrels need to get in the same order as their burrows using flex-direction. This CSS property defines the direction items are placed in the container, and accepts the following values:"
